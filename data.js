...
const CATEGORIAS = [
  { id: "tradicionais", nome: "Tradicionais",  subtitulo: "Cookies sem recheios mas com muito chocolate", icone: "🍪" },
  { id: "cookie-pies",  nome: "Cookie Pies",   subtitulo: "Cookies recheados para matar a vontade de doce", icone: "🥧" },
  { id: "combos",       nome: "Combos",        subtitulo: "Leve mais por menos! Confira nossos combos", icone: "🎁" },
  { id: "promocoes",    nome: "Promoções",     subtitulo: "Promoções exclusivas por tempo limitado", icone: "🔥" },
  { id: "encomendas",   nome: "Encomendas",    subtitulo: "Faça sua encomenda e presenteie a si ou alguém que ama! — combine a data de entrega", icone: "🎂" },
];
